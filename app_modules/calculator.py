...
def show_module():
    ...
    st.title("Sample Calculator to calculate Things ;)")
    st.write("Pay Award Calculator for Doctors and Dentists in training in England. Modified from https://github.com/coolshades/payawardcalc")
    # Create two columns
