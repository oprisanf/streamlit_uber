...
def show_module():
    ...
    st.write(
        ...
        This code is open source and available [here](https://github.com/tyler-simons/BackgroundRemoval)
        on GitHub. 
    ...
    if my_upload is not None:
        ...
        st.error("Please Upload an Image with a Background that needs to be removed")